...
class CETPH2H:
    ...
    def start_h2h_consumption(self):
        ...
        self._logger.info(" Initiating the task for consuming H2H requests.")
        self.h2h_queue_task = asyncio.ensure_future(self.consume_h2h_requests())                       # Task for consuming naptr-response records triggered by private hosts
